...
class ConfigurationTests(APITestCase):
    ...
    def setUp(self):
        self.repository = ConfigurationTests.repository
        self.spacex = ConfigurationTests.spacex
        self.dragon = ConfigurationTests.dragon
    ...
    def setUpClass(cls):
        ...
        """
        super(ConfigurationTests, cls).setUpClass()
