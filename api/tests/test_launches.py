...
class LaunchTests(SLNAPITests):
    ...
    def test_v300_upcoming_normal(self):
        ...
        self.assertEqual(data['count'], 2)
        launch = Launch.objects.get(pk=data['results'][0]['id'])
        self.assertEqual(data['results'][0]['id'], launch.id)
    ...
    def test_v300_launch_with_landings(self):
        ...
        self.assertEqual(data['id'], launch.id)
    ...
    def test_v320_launch_with_landings(self):
        launch = Launch.objects.get(pk=864)
