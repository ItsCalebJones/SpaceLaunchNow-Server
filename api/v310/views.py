...
class LaunchViewSet(ModelViewSet):
    ...
    filter_backends = (DjangoFilterBackend, SearchFilter, OrderingFilter)
    filter_fields = ('name', 'launcher__name', 'lsp__name', 'lsp__id', 'status', 'tbddate', 'tbdtime', 'launcher__id')
...
class UpcomingLaunchViewSet(ModelViewSet):
    ...
    filter_backends = (DjangoFilterBackend, SearchFilter, OrderingFilter)
    filter_fields = ('name', 'launcher__name', 'status', 'tbddate', 'tbdtime', 'launcher__id')
    search_fields = ('$name', '$launcher__name', '$lsp__name')
    ordering_fields = ('id', 'name', 'net',)
