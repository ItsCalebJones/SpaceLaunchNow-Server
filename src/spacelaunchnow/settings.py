...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv(
            "DATABASE_USERNAME", config.DATABASE["default"].get("USER", None)
        ),
        "PASSWORD": os.getenv(
            "DATABASE_PASSWORD", config.DATABASE["default"].get("PASSWORD", None)
        ),
        "HOST": os.getenv(
            "DATABASE_HOST", config.DATABASE["default"].get("HOST", None)
        ),
        "PORT": os.getenv(
            "DATABASE_PORT", config.DATABASE["default"].get("PORT", None)
        ),
    }
}
