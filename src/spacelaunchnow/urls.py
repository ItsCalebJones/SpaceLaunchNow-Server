...
def get_v350():
    ...
    v350_api_docs = [
        url(
            r"^api/3.5.0/swagger(?P<format>\.json|\.yaml)$",
            v350_api_schema_view.without_ui(cache_timeout=0),
            name="schema-json",
        ),
        url(
            r"^api/3.5.0/swagger$",
            v350_api_schema_view.with_ui("swagger", cache_timeout=0),
            name="schema-swagger-ui",
        ),
        url(
            r"^api/3.5.0/redoc/$",
            v350_api_schema_view.with_ui("redoc", cache_timeout=0),
            name="schema-redoc",
        ),
    ]
...
def get_v220():
    ...
    v220_api_docs = [
        url(
            r"^2.2.0/swagger(?P<format>\.json|\.yaml)$",
...
if settings.IS_WEBSERVER:
    ...
    web_settings = [
        ...
        url(
            r"^launch/upcoming/spacex$",
            landing_views.launches_spacex,
            name="launches_spacex",
        ),
        url(
            r"^launch/upcoming/florida$",
            landing_views.launches_florida,
            name="launches_florida",
        ),
        url(
            r"^launch/upcoming/vandenberg$",
            landing_views.launches_vandenberg,
            name="launches_vandenberg",
        ),
        url(r"^spacex/$", landing_views.launches_spacex, name="direct_launches_spacex"),
        url(
            r"^florida/$",
            landing_views.launches_florida,
            name="direct_launches_florida",
        ),
        url(r"^launch/(?P<id>\d+)/$", landing_views.launch_by_id, name="launch_by_id"),
        url(
            r"^launch/(?P<slug>[-\w]+)/$",
            landing_views.launch_by_slug,
            name="launch_by_slug",
        ),
        ...
        url(
            r"^vehicle/launcher/(?P<id>\d+)/$",
            landing_views.booster_reuse_id,
            name="booster_reuse_id",
        ),
        url(
            r"^vehicle/launcher/search/?$",
            landing_views.booster_reuse_search,
            name="booster_reuse_search",
        ),
        url(r"^vehicle/launch_vehicle$", LauncherConfigListView.as_view()),
        url(
            r"^vehicle/launch_vehicle/(\d+)/",
            landing_views.launch_vehicle_id,
            name="launch_vehicle_id",
        ),
        url(
            r"^vehicle/spacestation$",
            landing_views.spacestation_list,
            name="spacestation_list",
        ),
        url(
            r"^vehicle/spacestation/(?P<id>\d+)/$",
            landing_views.spacestation_by_id,
            name="spacestation_by_id",
        ),
        url(
            r"^vehicle/spacecraft$",
            landing_views.spacecraft_list,
            name="spacecraft_list",
        ),
        url(
            r"^vehicle/spacecraft/(?P<id>\d+)/$",
            landing_views.spacecraft_by_id,
            name="spacecraft_by_id",
        ),
        url(r"^astronaut/$", landing_views.astronaut_list, name="astronauts"),
        url(
            r"^astronaut/search/?$",
            landing_views.astronaut_search,
            name="astronaut_search",
        ),
        url(
            r"^astronaut/(?P<id>\d+)/$", landing_views.astronaut, name="astronaut_by_id"
        ),
        url(
            r"^astronaut/(?P<slug>[-\w]+)/$",
            landing_views.astronaut_by_slug,
            name="astronaut_by_slug",
        ),
        ...
        url(
            r"^app/privacy",
            TemplateView.as_view(template_name="web/app/privacy.html"),
            name="privacy",
        ),
        url(
            r"^app/tos",
            TemplateView.as_view(template_name="web/app/tos.html"),
            name="tos",
        ),
        url(
            r"^site/privacy",
            TemplateView.as_view(template_name="web/site/privacy.html"),
            name="privacy",
        ),
        url(
            r"^site/tos",
            TemplateView.as_view(template_name="web/site/tos.html"),
            name="tos",
        ),
        url(
            r"^ajax/astronaut/$",
            landing_views.astronaut_search_ajax,
            name="ajax-astronaut",
        ),
        ...
        url(
            r"^lazy_load_updates/(?P<id>[-\w]+)/$",
            landing_views.lazy_load_updates,
            name="lazy_load_updates",
        ),
    ]
...
urlpatterns = (
    default_settings + api_settings + web_settings + admin_settings + debug_settings
)
