...
def get_v350():
    ...
    v350_api_docs = [
        ...
        url(
            r"^api/3.5.0/swagger/$", v350_api_schema_view.with_ui("swagger", cache_timeout=0), name="schema-swagger-ui"
        ),
...
def get_v200():
    ...
    v200_api_docs = [
        ...
        url(r"^api/ll/2.0.0/redoc/$", v200_api_schema_view.with_ui("redoc", cache_timeout=0), name="v2_schema-redoc"),
    ]
...
def get_v210():
    ...
    v210_api_docs = [
        ...
        url(r"^api/ll/2.1.0/redoc/$", v210_api_schema_view.with_ui("redoc", cache_timeout=0), name="v2_schema-redoc"),
    ]
...
def get_v220():
    ...
    v220_api_docs = [
        url(
            r"^api/ll/2.2.0/swagger(?P<format>\.json|\.yaml)$",
            v220_api_schema_view.without_ui(cache_timeout=0),
            name="v2_schema-json",
        ),
        url(
            r"^api/ll/2.2.0/swagger/$",
            v220_api_schema_view.with_ui("swagger", cache_timeout=0),
            name="v2_schema-swagger-ui",
        ),
        url(r"^api/ll/2.2.0/redoc/$", v220_api_schema_view.with_ui("redoc", cache_timeout=0), name="v2_schema-redoc"),
        # Schema
