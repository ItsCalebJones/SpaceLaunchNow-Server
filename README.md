...
3. Create a config file copy with `cp spacelaunchnow/example_config.py spacelaunchnow/config.py` (Linux/MacOS) or `copy .\spacelaunchnow\example_config.py .\spacelaunchnow\config.py` (Windows)
