# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2019-07-23 18:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('news', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='bot.NewsItem')),
            ],
        ),
        migrations.AlterModelOptions(
            name='launchnotificationrecord',
            options={'verbose_name': 'Notification Record', 'verbose_name_plural': 'Notification Records'},
        ),
    ]
